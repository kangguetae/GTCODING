...
<body>
	...
	[<a href="/board/listPage_question?currentPage=${startNum-10}">이전</a>]
	</c:if>
	
	<c:forEach var="page" begin="${startNum}" end="${endNum}">
		
		<c:if test="${page ne currentPage}">
			<a href="/board/listPage_question?currentPage=${page}">${page}</a>
		</c:if>
	...
	[<a href="/board/listPage_question?currentPage=${startNum+10}">다음</a>]
	</c:if>
	<br>
